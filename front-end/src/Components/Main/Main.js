        ...
        <header>
          <nav className="navbar navbar-expand-lg navbar-dark mdb-color darken-4 fixed-top">
            ...
            <div className="collapse navbar-collapse" id="basicExampleNav">
              ...
              <form className="form-inline my-1">
                <button href="/Signin" className="btn btn-blue" type="submit" onClick={() => {
          ...
          <div className="hero-image">
            <div className="hero-text">
              ...
              <button href="/billing" className="btn btn-blue center" type="submit" onClick={() => {
          ...
          <Container>
            <section className="my-5 p-5 text-white">
              ...
              <p className="white-text w-responsive text-center mx-auto mb-5">
                Because we Merge your teams GitHub and Trello information
                and display it on a stylish Dashboard.
              </p>
              <Row>
                <Col lg="5" className="text-center text-lg-left">
                  <img className="img-fluid" src="./favicon/fav/dashboard.png" alt="Sample" />
                </Col>
                <Col lg="5">
                  <Row className="mb-3">
                    <Col size="1">
                  ...
                  <Row className="mb-3">
                    ...
                    <Col xl="10" md="11" size="10">
                      ...
                      <p className="grey-text">
                        All you need is to link your Team's Trello Board URL
                        and your Repository name from GitHub.
                      </p>
                    </Col>
                  </Row>
                  <Row className="mb-3">
                    ...
                    <Col xl="10" md="11" size="10">
                      ...
                      <p className="grey-text">
                        Create a fun competition to keep your team moral
                        high by being able to see the top contributors.
                      </p>
                    </Col>
                  </Row>
                </Col>
            ...
            <section id="team">
              ...
              <Row>
                <Col lg="3" md="6" className="mb-lg-0 mb-4">
                  <img src="./favicon/fav/jaxpic.jpg" className="rounded-circle z-depth-1 img-fluid m-.5" alt="Jackee" />
                ...
                <Col lg="3" md="6" className="mb-lg-0 mb-5">
                  <img src="./favicon/fav/Yasin.jpg" className="rounded-circle z-depth-2 img-fluid cover" alt="Sample avatar" />
                  <h5 className="font-weight-bold text-center blue-text mt-4 mb-3">
                    Yasin Shuman
                  </h5>
                <p className="text-uppercase text-center blue-text">Web Developer</p>
                  
                </Col>
                <Col lg="3" md="6" className="mb-lg-0 mb-5">
                  <img src="./favicon/fav/logo.png" className="rounded-circle z-depth-1 img-fluid" alt="Sample avatar" />
                  <h5 className="font-weight-bold text-center blue-text mt-4 mb-3">
                    Alex Figliolia
                  </h5>
                  <p className="text-uppercase text-center blue-text">
                ...
                <Col lg="3" md="6" className="mb-lg-0 mb-5">
                  <img src="./favicon/fav/hilal.jpg" className="rounded-circle z-depth-1 img-fluid" alt="Sample avatar" />
                ...
                <Col lg="3" md="6" className="mb-lg-0 mb-5">
                  <img src="./favicon/fav/untitled1.png" className="rounded-circle z-depth-1 img-fluid mt-5 large" alt="amanda" />
