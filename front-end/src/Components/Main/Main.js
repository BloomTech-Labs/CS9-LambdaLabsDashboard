            ...
            <section id="team">
              ...
              <Row>
                ...
                <Col lg="3" md="6" className="mb-lg-0 mb-5">
                  <img src="./favicon/fav/Yasin.jpg" className="rounded-circle z-depth-1 img-fluid cover" alt="Sample avatar" />
                  <h5 className="font-weight-bold text-center blue-text mt-4 mb-3">
                    Yasin Shuman
                  </h5>
                  <p className="text-uppercase text-center blue-text">
                ...
                <Col lg="3" md="6" className="mb-lg-0 mb-5">
                  <img src="./favicon/fav/2.png" className="rounded-circle z-depth-1" alt="Sample avatar" height="255" width="255" />
                  <h5 className="font-weight-bold text-center blue-text mt-4 mb-3 ">
                    Alex Figliolia
                  </h5>
                  <p className="text-uppercase text-center blue-text">
