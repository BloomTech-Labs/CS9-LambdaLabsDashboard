...
class Classes extends PureComponent {
  ...
  enter = () =>
    this.setState({ containerClasses: "classes classes-show", loader: false });
  ...
  closeConfirmDelete = () => {
    this.setState(
      {
        deleteClasses:
          "class-delete class-modal-show class-modal-enter class-modal-close"
      },
      () => {
  ...
  closeCreateClass = () => {
    this.setState(
      {
        createClasses:
          "class-create class-modal-show class-modal-enter class-modal-close"
      },
      () => {
        setTimeout(
          () =>
    ...
    if (newClassName.length > 2) {
      if (this.loopClasses(newClassName)) {
        this.setState(
          {
            createClasses:
              "class-create class-modal-show class-modal-enter class-modal-loading"
          },
          () => {
  ...
  deleteClass = () => {
    ...
    this.setState(
      {
        deleteClasses:
          "class-delete class-modal-show class-modal-enter class-modal-loading"
      },
      () => {
    ...
    setTimeout(() => {
      if (typeof res.data !== "string") {
        this.setState(
          {
            [el]: `${
              el === "deleteClasses" ? "class-delete" : "class-create"
            } class-modal-show class-modal-enter class-modal-loading class-modal-complete`
          },
          () => {
  ...
  render = () => {
    ...
    return (
      <div className={containerClasses}>
        ...
        />
        <button className="create-class" onClick={this.openCreateClass}>
          <div className="hor" />
          <div className="vert" />
        </button>
